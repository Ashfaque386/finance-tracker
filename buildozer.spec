...
package.domain = org.moneymanager
...
source.exclude_dirs = tests, bin, venv, __pycache__, .git, .buildozer, charts, backups
...
requirements = python3,kivy==2.3.0,kivymd==1.2.0,pillow,python-dateutil,android,pyjnius
